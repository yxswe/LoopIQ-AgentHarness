import type { AgentStreamOptions, AgentStreamOptionsPatch } from "../base/options.ts";

export function cloneStreamOptions(streamOptions?: AgentStreamOptions): AgentStreamOptions {
	return {
		...streamOptions,
...
export function applyStreamOptionsPatch(base: AgentStreamOptions, patch?: AgentStreamOptionsPatch): AgentStreamOptions {
