...
import type { AgentStreamOptions, AgentStreamOptionsPatch, ThinkingLevel } from "./options.ts";
import type { AgentResources, PromptTemplate, Skill } from "./resource.ts";
...
> {
	...
	resources: AgentResources<TSkill, TPromptTemplate>;
	previousResources: AgentResources<TSkill, TPromptTemplate>;
}
 ...
 * consumed by the runtime (see {@link AgentHookEventResultMap}). Unlike
...
export interface BeforeProviderRequestResult {
	streamOptions?: AgentStreamOptionsPatch;
}
 ...
 * may return for the runtime to consume. Only interceptable hook events appear
 ...
 * {@link AgentHookEvent} and yields the runtime-consumed result for that hook
 * type. The Session supplies this so the loop can route interceptable hooks
